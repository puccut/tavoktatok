...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Twitter", "Facebook", "Feed", "Flickr", "Linkedin", "Delicious", "Youtube", "Google") as $network) : ?>
			...
			<li class="social_li">
				<a class="social_link social_link__<?php echo strtolower($network); ?>" data-original-title="<?php echo strtolower($networks[$network]['label']); ?>" href="<?php echo $networks[$network]['link']; ?>" target="_blank">
					<?php if (($display == "both") or ($display =="icons")) { ?>
					
					<?php 
						$icon = strtolower($network); 
						if ($network == "Twitter")   $icon = "twitter-sign";
						if ($network == "Facebook")  $icon = "facebook-sign";
						if ($network == "Linkedin")  $icon = "linkedin-sign";
						if ($network == "Youtube")   $icon = "youtube-sign";
						if ($network == "Google")    $icon = "google-plus-sign";
						if ($network == "Feed")      $icon = "rss";
						if ($network == "Delicious") $icon = "th-large";
					?>
					<span class="social_ico"><i class="icon-<?php echo strtolower($icon);?>"></i></span>
