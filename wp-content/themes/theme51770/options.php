...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '#464646',
				'image' => get_stylesheet_directory_uri() . '/images/body-img.jpg',
				'repeat' => 'no-repeat',
				'position' => 'top center',
				'attachment'=>'fixed'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '23px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bbbaba'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#464646'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '40px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#464646'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#464646'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#464646'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#9dc02e'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#464646'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '15px', 'lineheight' => '23px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#7d7d7d'));

			//Extra Settings
			$options[] = array( 
								"name" => __("Extra Settings", CURRENT_THEME),
								"type" => "heading");

			$options['slogan'] = array( 
								"name" => __("Slogan", CURRENT_THEME),
								"desc" => __("Enter slogan used in the header. HTML tags are allowed.", CURRENT_THEME),
								"id" => "slogan",
								"std" => "PREPARING STUDENTS <br>
FOR SUCCESSFUL <br>
FUTURE",
								"type" => "textarea");
